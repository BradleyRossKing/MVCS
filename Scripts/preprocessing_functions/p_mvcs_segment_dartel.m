function o_matlabbatch = p_mvcs_segment_dartel(i_anat)
% 
...
template = fullfile(spm('dir'),'tpm','StimPlast_DARTEL_n75.nii');
...
o_matlabbatch{end}.spm.spatial.preproc.tissue(1).tpm = cellstr(strcat(template,',1'));
o_matlabbatch{end}.spm.spatial.preproc.tissue(1).ngaus = 1;
o_matlabbatch{end}.spm.spatial.preproc.tissue(1).native = [1 0];
o_matlabbatch{end}.spm.spatial.preproc.tissue(1).warped = [0 0];
o_matlabbatch{end}.spm.spatial.preproc.tissue(2).tpm = cellstr(strcat(template,',2'));
o_matlabbatch{end}.spm.spatial.preproc.tissue(2).ngaus = 1;
o_matlabbatch{end}.spm.spatial.preproc.tissue(2).native = [1 0];
o_matlabbatch{end}.spm.spatial.preproc.tissue(2).warped = [0 0];
o_matlabbatch{end}.spm.spatial.preproc.tissue(3).tpm = cellstr(strcat(template,',3'));
o_matlabbatch{end}.spm.spatial.preproc.tissue(3).ngaus = 2;
o_matlabbatch{end}.spm.spatial.preproc.tissue(3).native = [1 0];
o_matlabbatch{end}.spm.spatial.preproc.tissue(3).warped = [0 0];
o_matlabbatch{end}.spm.spatial.preproc.tissue(4).tpm = cellstr(strcat(template,',4'));
o_matlabbatch{end}.spm.spatial.preproc.tissue(4).ngaus = 3;
o_matlabbatch{end}.spm.spatial.preproc.tissue(4).native = [1 0];
o_matlabbatch{end}.spm.spatial.preproc.tissue(4).warped = [0 0];
o_matlabbatch{end}.spm.spatial.preproc.tissue(5).tpm = cellstr(strcat(template,',5'));
o_matlabbatch{end}.spm.spatial.preproc.tissue(5).ngaus = 4;
o_matlabbatch{end}.spm.spatial.preproc.tissue(5).native = [1 0];
o_matlabbatch{end}.spm.spatial.preproc.tissue(5).warped = [0 0];
o_matlabbatch{end}.spm.spatial.preproc.tissue(6).tpm = cellstr(strcat(template,',6'));
o_matlabbatch{end}.spm.spatial.preproc.tissue(6).ngaus = 2;
o_matlabbatch{end}.spm.spatial.preproc.tissue(6).native = [1 0];
...
o_matlabbatch{end}.spm.spatial.preproc.warp.write = [1 1];
